...
RUN pecl install mcrypt-1.0.3 && docker-php-ext-enable mcrypt && pecl install imagick && docker-php-ext-enable imagick 

# Add the Omeka-S PHP code
COPY ./omeka-s-3.2.2/omeka-s /var/www/html
# RUN unzip -q /var/www/omeka-s-1.4.0.zip -d /var/www/ \
# RUN unzip /var/www/omeka-s-3.2.2.zip -d /var/www/ \
# &&  rm /var/www/omeka-s-3.2.2.zip \
# &&  rm -rf /var/www/html/ \
...
COPY ./omeka-s-modules_v3x/modules/ /var/www/html/modules/
...
# RUN unzip /var/www/html/omeka-s-modules_v3x.zip -d /var/www/html/ 
# &&  rm /var/www/html/omeka-s-modules_v3x.zip
